...
<html xmlns="http://www.w3.org/1999/x html">
	...
	<body>
			...
			<div id="page-content" class="clearfix">
				<div class="row-fluid">
					<div class="page-header position-relative">
						<h1>图书信息<small> <i class="icon-double-angle-right"></i>&nbsp;&nbsp;上传元数据信息</small></h1>
					</div>
					<div class="row-fluid">
						<div class="table-header on">基本信息</div>
						<form id="ProductForm" commandName="form" class="form-horizontal" enctype="multipart/form-data">
							<div class="on-down">
								<div class="control-group" id="xmlFileDiv">
									<label class="control-label">xml文件上传：</label>
									<div class="controls">
                                           <input type="File" name="xmlFile" id="xmlFile" class="span6" onblur="Content.Product.ProductInfo.UploadXml();" />
                                           <span id="xmlFileSpan" class="help-inline"></span>
									</div>
								</div>
							</div>
		...
		<script type="text/javascript" src="${request.contextPath}/js/product/ProductXml.js"></script>
