...
<html xmlns="http://www.w3.org/1999/x html">
	...
	<body>
			...
			<div id="page-content" class="clearfix">
				<div class="row-fluid">
					<div class="page-header position-relative">
						<h1>分类信息<small> <i class="icon-double-angle-right"></i>&nbsp;&nbsp;新建子分类</small></h1>
					</div>
					<div class="row-fluid">
						...
						<form id="ProductTypeForm" commandName="form" class="form-horizontal">
							<div class="on-down">
								<div class="control-group" id="nameDiv">
									...
									<div class="controls">
										<input id="name" name="obj.name" class="span6" placeholder="类型名称" onblur="Content.ProductType.Info.ProductTypeName();"/>
								...
								<div class="control-group" id="codeDiv">
									...
									<div class="controls">
										<input id="internationCode" name="obj.internationCode" class="span6" placeholder="国际化参数" />
										<span id="codeSpan" class="help-inline"></span>
									</div>
								</div>
								<input type="hidden" name="obj.code" value="${form.code}" />
								<input type="hidden" name="obj.treeCode.id" value="${form.id}" />
							</div>
		...
		<script type="text/javascript" src="${request.contextPath}/js/productType/ProductTypeAdd.js"></script>
	</body>
</html>
