...
<html xmlns="http://www.w3.org/1999/x html">
	...
	<body>
					...
					<div class="row-fluid">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tfoot>
								<tr>
									<td>GET</td>
									<td class="left"><a href="${scheme}://${serverName}:${port}${request.contextPath}/pages/form/invoke" target="_blank">${scheme}://${serverName}:${port}${request.contextPath}/pages/form/invoke</td>
		...
		$(".btn-primary").on("click", function() {
			$.get("${request.contextPath}/pages/form/invoke", "", function(data) {
				$("#json").html(data);
			}, "text");
		});
		//-->
