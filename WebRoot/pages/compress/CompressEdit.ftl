			...
			<div id="page-content" class="clearfix">
				<div class="row-fluid">
					<div class="page-header position-relative">
						<h1>产品包信息 <small> <i class="icon-double-angle-right"></i>&nbsp;&nbsp;<#if ("" == form.id || 0 == form.id)>新增资源包<#else>修改资源包信息</#if></small></h1>
					</div>
					<div class="row-fluid">
						...
						<form id="CompressForm" commandName="form" class="form-horizontal">
							...
							<div class="on-down">
								<div class="control-group">
									<label class="control-label">产品包名：</label>
									<div class="controls">
										<input id="title" class="span6" name="obj.title" value="${form.obj.title}"/>
									</div>
								</div>
